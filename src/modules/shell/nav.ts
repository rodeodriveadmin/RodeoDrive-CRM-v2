...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { labelKey: "nav.tickets", href: "/tickets", icon: Ticket, policy: "TICKETS", ready: true },
      { labelKey: "nav.deals", href: "/deals", icon: Handshake, policy: "DEALS", ready: true },
      { labelKey: "nav.campaigns", href: "/campaigns", icon: Megaphone, policy: "CAMPAIGNS", ready: true },
